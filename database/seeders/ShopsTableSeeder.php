...
class ShopsTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $param = [
            ...
            'holiday' => '木曜日',
            'shop_img' => 'kitachokulogo.001-removebg-preview.jpg',
            'shop_img_rename' => 'id1.jpg'
        ];
        Shop::create($param);
